...
!1,!0),isUnknown:e(I,!1,!0),expand:e(Q,!1,!0),map:e(N,!1,!0),destruct:e(function(a){if(!a.maps)return console.error(Error("You can not destruct a map that has already be destructed"));a.maps.splice(a.mapIndex,1);var c=a.maps.length,b=0;for(b;b<c;b++)a.maps[b].mapIndex=b;a.mapText[a.mapTextIndex]="";Object.defineProperties(a,{node:e(null,!0,!0,!1),value:e(null,!0,!0,!1),values:e([],!0,!0,!1),local:e(null,!0,!0,!1),maps:e(null,!0,!0,!1),nodeMaps:e(null,!0,!0,!1),mapText:e(null,!0,!0,!1),datalistener:e(null,
!0,!0,!1),domlistener:e(null,!0,!0,!1),data:e(null,!0,!0,!1)})},!1,!0)});"function"===typeof define&&define.amd&&define("czosnek",function(){return F});"object"===typeof module&&"object"===typeof module.exports&&(module.exports.czosnek=F);return F}();